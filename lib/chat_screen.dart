...
//                         chatId: chatId!,
//                       )
//                     : Center(child: Text('Khong co tin nhan')),
//               ),
//               Container(
//                 color: Colors.white,
...
//           ],
//           borderRadius: isMe ? BorderRadius.only(topLeft: Radius.circular(15),bottomLeft: Radius.circular(15),bottomRight: Radius.circular(15) ):BorderRadius.only(topRight: Radius.circular(15),bottomLeft: Radius.circular(15),bottomRight: Radius.circular(15) ) ,
